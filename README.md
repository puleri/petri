...
The runtime preallocates 35 regular germs, one elite, and one shared slot for the 50,000-, 100,000-, and 150,000-point bosses, plus 80 fragments, 240 projectiles, three turrets, 48 mines, four pickup/aura slots, three boon-choice entries, and 64 goo patches. No account, networking, backend, leaderboard, touch controls, or per-projectile node creation is included in v1.
# petri
